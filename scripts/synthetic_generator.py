"""
Synthetic Question Generator — Session 2
...
def display_questions(questions: list, doc_name: str, persona: str):
    console.print()
    console.print(Panel(
...
def main():
    ...
    parser.add_argument("--save", type=str, help="Save output to a JSON file")
    ...
    if args.all_docs:
        ...
        demo_docs = ["02_premium_membership.md", "07_promotional_events.md", "11_internal_pricing.md"]
    ...
    if args.critique:
        ...
        for q in all_generated:
            ...
            crit_table.add_row(
                q["id"], q["query"][:43] + "...",
                str(c.get("realism", "?")), str(c.get("difficulty_actual", "?")),
                f"[{flag_color}]{flag}[/]", c.get("note", "")[:28],
            )
